...
164 tests as of this writing, covering the engine modules
...
and every command/skill's static assets (frontmatter, `${CLAUDE_PLUGIN_ROOT}`
usage, absence of personal data).
